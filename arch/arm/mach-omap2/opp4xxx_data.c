...
#define OMAP4430_VDD_MPU_OPP00_UV    900000
...
{.main_vdd_volt = OMAP4430_VDD_MPU_OPPOFF_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP50_UV},
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	 /* MPU OPPOFF - OPPOFF */
  OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 70000000, OMAP4430_VDD_MPU_OPPOFF_UV),
  /* MPU OPPOFF - OPP00 */
 ...
 /* MPU OPP2 - OPP75 */
  OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 450000000, OMAP4430_VDD_MPU_OPP75_UV),
  /* MPU OPP3 - OPP100 */
  ...
  /* MPU OPP4 - OPP-Turbo */
  OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 858000000, OMAP4430_VDD_MPU_OPPTURBO_UV),
  /* MPU OPP5 - OPP-NT */
OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1008000000, OMAP4430_VDD_MPU_OPPNITRO_UV),
  ...
  /* SGX OPP4 - OPP100 */
  OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 400000000, OMAP4430_VDD_CORE_OPP100_UV),
	/* FDIF OPP1 - OPP25 */
