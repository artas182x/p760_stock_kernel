...
#define OMAP4430_VDD_MPU_OPP00_UV    875000
#define OMAP4430_VDD_MPU_OPP50_UV    915000
#define OMAP4430_VDD_MPU_OPP75_UV    950000
#define OMAP4430_VDD_MPU_OPP100_UV    1000000
#define OMAP4430_VDD_MPU_OPPTURBO_UV    1180000
#define OMAP4430_VDD_MPU_OPPNITRO_UV    1260000
#define OMAP4430_VDD_MPU_OPPNITRO2_UV    1310000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV    1340000
#define OMAP4430_VDD_MPU_OPPNITROSB2_UV  1355000
#define OMAP4430_VDD_MPU_OPPNITROSB3_UV  1370000
#define OMAP4430_VDD_MPU_OPPNITROSB4_UV  1385000
#define OMAP4430_VDD_MPU_OPPNITROSB5_UV  1420000
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
  ...
  VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP75_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
...
{.main_vdd_volt = OMAP4430_VDD_MPU_OPP00_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP50_UV},
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
  /* MPU OPPOFF - OPP00 */
  OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 100000000, OMAP4430_VDD_MPU_OPP00_UV),
  /* MPU OPP1 - OPP50 */
...
OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1008000000, OMAP4430_VDD_MPU_OPPNITRO_UV),
	/* MPU OPP6 - OPP-NT2 */
  OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1108000000, OMAP4430_VDD_MPU_OPPNITRO2_UV),
  /* MPU OPP7 - OPP-SB */
  OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1208000000, OMAP4430_VDD_MPU_OPPNITROSB_UV),
  /* MPU OPP8 - OPP-SB2 */
  OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1254000000, OMAP4430_VDD_MPU_OPPNITROSB2_UV),
  /* MPU OPP9 - OPP-SB3 */
...
/* MPU OPP11 - OPP-SB5 */
  OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1408000000, OMAP4430_VDD_MPU_OPPNITROSB5_UV),
	...
	/* SGX OPP4 - OPP100 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 410000000, OMAP4430_VDD_CORE_OPP100_UV),
	/* FDIF OPP1 - OPP25 */
...
if (omap4_has_mpu_1_1ghz())
    omap4_opp_enable("mpu", 1108000000);
	if (omap4_has_mpu_1_2ghz())
		omap4_opp_enable("mpu", 1208000000);
